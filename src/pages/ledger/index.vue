<template>
  <view>
    <view class="range-bar" @click="openPicker">
      ...
      <view class="range-actions"><text class="statistics-link" @click.stop="goStatistics">统计</text><text class="range-arrow">⌄</text></view>
    </view>
...
function goStatistics() { uni.navigateTo({ url: '/pages/ledger/expense-statistics' }) }
