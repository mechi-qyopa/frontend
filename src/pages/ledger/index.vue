<template>
  <view>
    <view class="range-bar" @click="openPicker">
      ...
      <view class="range-actions"><text class="range-arrow">⌄</text></view>
    </view>
...
.range-actions { display: flex; align-items: center; justify-content: center; width: 52rpx; height: 52rpx; border-radius: 16rpx; background: #f5f8fd; }.range-arrow { color: #667085; font-size: 34rpx; }
</style>
