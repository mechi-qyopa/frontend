<template>
  <view>
    ...
    <view class="card info"><text>当前身份</text><text>{{ authStore.profile?.role || 'USER' }}</text></view>
...
<style scoped>
.profile-head { display: flex; align-items: center; gap: 24rpx; padding: 64rpx 40rpx 52rpx; color: #fff; background: linear-gradient(135deg, #1677ff, #76aeff); }.avatar-trigger { position: relative; width: 116rpx; height: 116rpx; }.avatar { display: flex; align-items: center; justify-content: center; width: 108rpx; height: 108rpx; overflow: hidden; border: 4rpx solid rgba(255,255,255,.6); border-radius: 50%; background: rgba(255,255,255,.2); font-size: 44rpx; }.avatar-image { display: block; }.avatar-badge { position: absolute; right: -8rpx; bottom: -2rpx; padding: 4rpx 10rpx; border-radius: 16rpx; color: #1677ff; background: #fff; font-size: 20rpx; line-height: 1.3; }.username,.phone { display: block; }.username { font-size: 36rpx; font-weight: 600; }.phone { margin-top: 10rpx; color: rgba(255,255,255,.78); font-size: 25rpx; }.activity-card { margin-bottom: 0; padding: 28rpx 24rpx; }.activity-title { display: block; margin: 0 4rpx 24rpx; color: #344054; font-size: 29rpx; font-weight: 600; }.activity-stats { display: flex; }.activity-stat { display: flex; flex: 1; flex-direction: column; align-items: center; gap: 10rpx; }.activity-stat + .activity-stat { border-left: 1rpx solid #eaecf0; }.activity-value { color: #1677ff; font-size: 38rpx; font-weight: 700; }.activity-label { color: #98a2b3; font-size: 22rpx; }.info,.category-entry { display: flex; align-items: center; justify-content: space-between; color: #667085; }.category-entry { margin-top: 0; }.entry-title,.entry-subtitle { display: block; }.entry-title { color: #344054; font-size: 29rpx; }.entry-subtitle { margin-top: 10rpx; color: #98a2b3; font-size: 23rpx; }.entry-arrow { color: #98a2b3; font-size: 42rpx; }.logout { margin: 52rpx 24rpx; color: #e11d48; background: #fff1f2; }.avatar-mask { position: fixed; z-index: 1000; top: 0; right: 0; bottom: 0; left: 0; display: flex; align-items: flex-end; background: rgba(0,0,0,.52); }.avatar-dialog { width: 100%; padding: 18rpx 28rpx calc(28rpx + env(safe-area-inset-bottom)); border-radius: 32rpx 32rpx 0 0; background: #fff; box-sizing: border-box; }.dialog-handle { width: 72rpx; height: 8rpx; margin: 0 auto 30rpx; border-radius: 10rpx; background: #e4e7ec; }.dialog-title,.dialog-tip { display: block; text-align: center; }.dialog-title { color: #1d2939; font-size: 34rpx; font-weight: 600; }.dialog-avatar { display: flex; align-items: center; justify-content: center; width: 200rpx; height: 200rpx; margin: 28rpx auto 20rpx; overflow: hidden; border-radius: 50%; background: #f2f4f7; color: #98a2b3; font-size: 68rpx; }.dialog-tip { margin-bottom: 28rpx; color: #667085; font-size: 25rpx; }.change-avatar { color: #1677ff; background: #edf5ff; }.confirm-avatar { margin-top: 18rpx; color: #fff; background: #1677ff; }.cancel-avatar { margin-top: 18rpx; color: #667085; background: #f2f4f7; }.crop-mask { position: fixed; z-index: 1001; top: 0; right: 0; bottom: 0; left: 0; display: flex; align-items: center; justify-content: center; padding: 40rpx; background: rgba(0,0,0,.65); }.crop-dialog { width: 100%; padding: 34rpx 28rpx 28rpx; border-radius: 24rpx; background: #fff; box-sizing: border-box; }.crop-title,.crop-tip { display: block; text-align: center; }.crop-title { color: #1d2939; font-size: 34rpx; font-weight: 600; }.crop-tip { margin: 12rpx 0 28rpx; color: #667085; font-size: 24rpx; }.crop-window { position: relative; margin: 0 auto; overflow: hidden; background: #1d2939; touch-action: none; }.crop-image { position: absolute; top: 0; left: 0; max-width: none; }.crop-tools { display: flex; align-items: center; justify-content: center; gap: 24rpx; margin: 26rpx 0; color: #667085; font-size: 26rpx; }.crop-control { min-width: 136rpx; margin: 0; color: #1677ff; background: #edf5ff; font-size: 25rpx; }.crop-actions { display: flex; gap: 20rpx; }.crop-actions button { flex: 1; margin: 0; }.crop-cancel { color: #667085; background: #f2f4f7; }.crop-confirm { color: #fff; background: #1677ff; }.crop-canvas { position: fixed; top: -1000px; left: -1000px; width: 600px; height: 600px; opacity: 0; pointer-events: none; }
</style>
