<template>
  <view :class="['profile-page', `theme-${themeStore.id}`]" :style="themeStore.pageStyle">
    <view class="profile-head" :style="profileHeadStyle">
      ...
      <view class="user-meta"><text class="username">{{ authStore.profile?.username || '用户' }}</text><text class="phone">{{ authStore.profile?.phone || '' }}</text></view>
    </view>
